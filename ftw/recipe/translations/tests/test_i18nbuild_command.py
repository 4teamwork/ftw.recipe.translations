...
class TestI18nbuildCommand(TestCase):
    ...
    def test_rebuilds_primary_domain_pot_files(self):
        ...
        build_translations(self.tempdir, 'foo', output=None)
    ...
    def test_syncs_po_files_of_existing_languages(self):
        ...
        output = StringIO()
        build_translations(self.tempdir, 'foo', output=output)
    ...
    def test_syncs_only_selected_languages(self):
        ...
        build_translations(self.tempdir, 'foo', new_languages=['en'], output=None)
    ...
    def test_does_not_sync_manual_pot_files(self):
        ...
        build_translations(self.tempdir, 'foo', new_languages=['de'], output=None)
